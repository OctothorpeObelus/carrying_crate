...
ENT.Type        = "anim"
ENT.PrintName   = "Pallet Box" --Human readable name of the object (Undo, Spawnmenu, etc.)
ENT.Author      = "Geemar"
...
--Crate attributes
ENT.Model = "models/carriers/palletcarry02.mdl"
...
ENT.Box = {
    ...
    max = Vector(37.493,32.519,46.000),
}
...
ENT.TippingPoint = { --Optional paramter. Defines the Angles at which any cargo inside will be dropped. If not defined the crate will never automatically drop its contents.
    min = Angle(-50,-180,-50),   --Minimum angle to dump contents
    max = Angle(50,180,50)       --Maximum angle to dump contents
}
